...
export const Pricing = () => {
  return (
    ...
    <div className="flex flex-col gap-6 items-center mt-10 lg:flex-row lg:items-end lg:justify-center">
        ...
        <div key={title} className={twMerge("card", inverse === true && "bg-black text-white border-black ")}> 
        ...
        className="bg-[linear-gradient(to_right,#DD7DDF,#E1CD86,#BBCB92,#71C2EF,#3BFFFF,#DD7DDF,#E1CD86,#BBCB92,#71C2EF,#3BFFFF)] [bacground-size:200%] text-transparent bg-clip-text font-medium"
        >
        Popular
          </motion.span>
          </div>
        ...
        <div className="flex items-baseline gap-1 mt-[30px]">
          ...
          <span className="tracking-tighter font-bold text-blsck/50">/month</span>
        </div>
